...
# Ze waren er 2 maanden geleden en nu zijn ze er niet meer! Dus download van mijn repository hier:
...
# fasta  reference file (per chromosome or the compelte thing) should be renamed to "lumter.fasta"
...
tophat lumter     sample_1.fastq  sample_2.fastq
 ...
 # Als alternatief kun je een lus gebruiken, maar  je hebt er een super krachtige processor voor nodig
