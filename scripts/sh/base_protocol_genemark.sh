...
then
  ...
  $dir/gmhmme3  -o GeneMark-E-tests/GeneMark.hmm/test/output_genemark.gff3  -m GeneMark-E-tests/GeneMark.hmm/input/athaliana.mod  -f gff3  GeneMark-E-tests/GeneMark.hmm/input/input_sequence.fasta 
